...
def test_decode_roi():
    ...
    dec_srcs = [
        code_stream0.getSubCodeStream(region = roi),
        code_stream1.getSubCodeStream(region = roi),
        code_stream2.getSubCodeStream(region = roi),
    ]
...
def test_decode_batch_roi():
    ...
    dec_srcs = [
        cs.getSubCodeStream(region = roi)
