...
class NvTiffCudaDecoderPlugin
{
  public:
    explicit NvTiffCudaDecoderPlugin(const nvimgcodecFrameworkDesc_t* framework);
  ...
  private:
    ...
    static constexpr const char* plugin_id_ = "nvtiff_cuda_decoder";
